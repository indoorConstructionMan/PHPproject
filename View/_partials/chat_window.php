<div id="chat_window_<?= $chat_window->id ?>" class="chat_window myrtle full-height-100 chat-tab-fix">
    ...
    <div class="chat_window_input full-height-20 myrtle">
        <textarea class="full-height-90 full-width white shadow-inset-light border-top-none <?=$GLOBALS['config']['chat_colors_default']['name']?>-text medium-font-size padding1 myrtle-border border10"></textarea>
        <div class="no-display white lineheight-zero margin-none">
